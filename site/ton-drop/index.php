...
<body>
    ...
    <div class="body-container">
        ...
        <div class="text-container">
            <h1 class="brand-name">SOVCUBE-DROP</h1>
            <h2>Buy the token on TON chain, and claim BSOV Tokens when SovCube is released.</h2>

	    <p><b>Step 1.</b> Buy SOVCUBE-DROP</p>
	<p><b>Step 2.</b> Send your SOVCUBE-DROP to the burn address at: EQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAM9c<br>
